...
class APIs {
    ...
    try {
      ...
      var response = await post(
          ...
          headers: {
            ...
            'key=AAAAQueaSbA:APA91bF3AWmEV7TiD_KlwqQpRwBuUl5flys8CC4JwPcQZeGGfU1SwX0Ok2sPl2ySWwnxbGRaHzXyEk7UfQzAZB4iizG1pGX9QJAcoC_-wER7VMJtY3XNl7ut83bUyCXxOG75eMAspXjC',
          },
  ...
  static Future<void> deleteMessage(Message message) async {
    firestore.collection('chats/${getConversationID(message.toId)}/messages')
        .doc(message.sent)
        .delete();
